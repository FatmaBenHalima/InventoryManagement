...
function show_hide()
{
var x = '<%= request.getParameter("role") %>';
if(x=="Management")
	{
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Overview about WareHouse Management System</strong>
                        </div>
                        <div class="card-body">
                          <!-- Credit Card -->
                          <div id="pay-invoice">
                              <div class="card-body">
                                <iframe width="100%" height="595" src="https://www.youtube.com/embed/4TRFJt3OCFM?rel=0&amp;controls=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                              </div>
                          </div>
